...
datt = datetime.date.today()
dnam = now.strftime("%A")
niya = time.strftime("%H:%M:%S %p")
        ...
        if settings["welcome"]:
            for u in message.new_chat_members:
                ...
                temp.MELCOW['welcome'] = await message.reply_photo(  
                                                 ...
                                                 caption=f'<b>Hey, {u.mention} 👋🏻\nWelcome To Our Group {message.chat.title}\n\nYou Can Find Movies / Series / Animes etc. From Here. Enjoy 😉.\n\n<b>┏≫ ғᴏʟʟᴏᴡ ɢʀᴏᴜᴘ ʀᴜʟᴇs</b>\n┣ <b>ʏᴏᴜᴛᴜʙᴇ ᴄʜᴀɴɴᴇʟ ›› <a href=https://youtube.com/OpusTechz>ᴏᴘᴜs ᴛᴇᴄʜᴢ</a></b></code>\n<b>┗≫ ғᴏʟʟᴏᴡ ɢʀᴏᴜᴘ ʀᴜʟᴇs</b>\n\nനിങ്ങൾക്ക് ഇവിടെ നിന്ന് സിനിമകൾ / സീരീസ് / ആനിമുകൾ മുതലായവ ലഭിക്കുന്നത് ആണ്..\n\n© <a href=https://t.me/MWUpdatez><b>ᴍᴡ ᴜᴘᴅᴀᴛᴇᴢ</b></a></b>',
                                                 reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('🔰 ɢʀᴏᴜᴘ ʀᴜʟᴇs 🔰', url='https://t.me/Devil0Bot_Bot?start=BATCH-BQADBQADngYAArJcAVUegzveRZ83wBYE') ] ] )
                )
